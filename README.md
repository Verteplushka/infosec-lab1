...
В рамках лабораторной работы в проекте реализован базовый набор мер по обеспечению безопасности веб-приложения, направленный на защиту от распространённых уязвимостей (SQL Injection, XSS), а также на контроль доступа и аутентификацию пользователей.
